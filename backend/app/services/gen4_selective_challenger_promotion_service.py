...
def target_admission_provenance(wallet: str) -> dict[str, Any]:
    ...
    if evidence is not None:
        ...
        if label in R10_FORMAL_M74_WALLETS:
            return {
                "kind": R10_FORMAL_M74_ADMISSION_KIND,
                "label": label,
                "wallet": value,
                "upstream_formal_m74_pass": True,
                "upstream_economic_m74_qualification": True,
                "upstream_formal_m74_report_sha256": R10_MAXYIELD_FORMAL_REPORT_SHA256,
                "upstream_admission_readiness_report_sha256": None,
                "formal_m74_evidence": evidence,
                "historical_open_positions_quarantined": False,
                "candidate_entry_evidence_backfilled": False,
            }
        if label in R12_FORMAL_M74_WALLETS:
            return {
                "kind": R12_FORMAL_M74_ADMISSION_KIND,
                "label": label,
                "wallet": value,
                "upstream_formal_m74_pass": True,
                "upstream_economic_m74_qualification": True,
                "upstream_formal_m74_report_sha256": R12_STATE_SHA256,
                "upstream_admission_readiness_report_sha256": R12_FULL31_REPORT_SHA256,
                "formal_m74_evidence": evidence,
                "historical_open_positions_quarantined": False,
                "candidate_entry_evidence_backfilled": False,
            }
        if label in R14_FORMAL_M74_WALLETS:
            return {
                "kind": R14_FORMAL_M74_ADMISSION_KIND,
                "label": label,
                "wallet": value,
                "upstream_formal_m74_pass": True,
                "upstream_economic_m74_qualification": True,
                "upstream_formal_m74_report_sha256": R14_REPORT_SHA256,
                "upstream_admission_readiness_report_sha256": R14_DIVERSIFICATION_AUDIT_SHA256,
                "formal_m74_evidence": evidence,
                "historical_open_positions_quarantined": False,
                "candidate_entry_evidence_backfilled": False,
            }
        if label in R13_FORMAL_M74_WALLETS:
            return {
                "kind": R13_FORMAL_M74_ADMISSION_KIND,
                "label": label,
                "wallet": value,
                "upstream_formal_m74_pass": True,
                "upstream_economic_m74_qualification": True,
                "upstream_formal_m74_report_sha256": R13_REPORT_SHA256,
                "upstream_admission_readiness_report_sha256": R13_INDEPENDENCE_AUDIT_SHA256,
                "formal_m74_evidence": evidence,
                "historical_open_positions_quarantined": False,
                "candidate_entry_evidence_backfilled": False,
            }
